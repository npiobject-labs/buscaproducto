# buscaproducto — instrucciones del proyecto
...
El repositorio `npiobject-labs/buscaproducto`, rama `main`, es la **única** fuente de verdad, tanto para el código como para la documentación de `docs/planificacion/`. Todo lo que importe vive aquí y se edita aquí.
...
| Qué | URL | Despliegue |
|---|---|---|
| Mock estático (Pages) | https://npiobject-labs.github.io/buscaproducto/ | `.github/workflows/pages.yml` en push a `main` |
...
Si necesitas comprobar algo desde la sesión, hazlo contra la API de GitHub (`https://api.github.com/repos/npiobject-labs/buscaproducto/actions/runs/...`), que sí es accesible.
...
Página pública: https://npiobject-labs.github.io/buscaproducto/bitacora.html · formato en `docs/bitacora/README.md`.
